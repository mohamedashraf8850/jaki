...
import 'package:jaki_kapten/FrontEnd/account/register.dart';
import 'package:jaki_kapten/ToolsApp/app_Colors.dart';

import 'login.dart';

class RegisterTabsPage extends StatefulWidget {
  @override
  _AccountTabsPageState createState() => _AccountTabsPageState();
}

class _AccountTabsPageState extends State<RegisterTabsPage> {
  @override
